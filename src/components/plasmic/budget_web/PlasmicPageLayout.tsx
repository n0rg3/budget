...
import sty from "./PlasmicPageLayout.module.css"; // plasmic-import: 3k5-R8201TZc/css

import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: Fu1svQ2i7zq-/icon
import Icon2Icon from "./icons/PlasmicIcon__Icon2"; // plasmic-import: X2kFdAvOFGi2/icon
...
function PlasmicPageLayout__RenderFunc(props: {
  ...
  return (
    <RichLayout
      ...
      logoElement={
        <Icon2Icon
          className={classNames(projectcss.all, sty.svg__wxzfL)}
          role={"img"}
        />
      }
      navMenuItems={(() => {
    ...
    >
      <LoadingBoundary
        ...
        loadingState={
          <DataCtxReader__>
            {$ctx => (
              <div className={classNames(projectcss.all, sty.freeBox__uc1Dj)}>
                <IconIcon
                  className={classNames(projectcss.all, sty.svg__v863B)}
                  role={"img"}
                />
              </div>
            )}
      ...
      >
        <DataCtxReader__>
          {$ctx => (
            <div className={classNames(projectcss.all, sty.freeBox__siGvR)}>
              {renderPlasmicSlot({
                defaultContents: (
                  <section
                    className={classNames(projectcss.all, sty.section__olMjz)}
                  >
                    <h1
                      className={classNames(
                        projectcss.all,
